...
Type
  ...
  public
    ...
    procedure CarregarPedido(NumeroPedido: Integer; out Pedido: TPedidoDadosGerais; out Produtos: TList<TPedidosProdutos>);
...
procedure TPedidosController.CarregarPedido(NumeroPedido: Integer; out Pedido: TPedidoDadosGerais; out Produtos: TList<TPedidosProdutos>);
var
  FQuery: TFDQuery;
